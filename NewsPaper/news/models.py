...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        rating_posts_author = Post.objects.filter(author_id=self.pk).aaggregate(post_rating=Sum('post_rating'))['post_rating']  # noqa: E501
        ...
        self.author_rating = (rating_posts_author + rating_comments_author + rating_comments_posts) * 3  # noqa: E501
